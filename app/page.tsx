  ...
  return (
    <div className="bg-white">
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="flex space-x-20 items-center justify-between p-6 lg:px-8">
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="#"
              ...
              border-2 border-gray-100 p-2 rounded w-auto
              "
            >
              Log in | Register
            </a>
      ...
      <div className="relative isolate px-6 pt-10 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl pt-20 sm:pt-48 lg:pt-56">
          <div className="text-left">
            ...
            >
              Secure solutions for digital assets and money easily
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              The easiest, safest and fastest app for cryptocurrency. 
              banks for international money transfers and online money 
              transfer services considered the safest way.
            </p>
